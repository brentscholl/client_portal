<div>
    <div class="grid grid-cols-12 mb-4">
        ...
        <div class="col-span-7 pr-2 grid grid-cols-2">
        ...
        <div class="col-span-4">
            <x-input.text wire:model="search" label="Search" placeholder="Search Projects..."/>
        </div>
    </div>
            ...
            <div class="align-middle inline-block min-w-full shadow sm:rounded-lg border-b border-gray-200">
                <table class="s-table">
                    ...
                    @foreach($projects as $project)
                        @livewire('admin.projects.project-row', [$project], key('project-row-'.$project->id))
                    @endforeach
                    </tbody>
                </table>
            </div>
